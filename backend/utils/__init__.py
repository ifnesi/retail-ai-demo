...
# Kafka Topics
# CDC topics (created by Postgres CDC connector)
RETAIL_DEMO_USERS = "db_public_users"
RETAIL_DEMO_STORES = "db_public_stores"
RETAIL_DEMO_PRODUCTS = "db_public_products"
RETAIL_DEMO_PARTNERS = "db_public_partners"
